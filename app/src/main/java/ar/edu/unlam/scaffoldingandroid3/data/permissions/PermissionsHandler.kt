...
class PermissionsHandler
    ...
    constructor(
        ...
        fun requestBasicPermissions(
            activity: Activity,
            requestCode: Int = REQUEST_BASIC_PERMISSIONS,
        ) {
            val permissionsToRequest =
                basicPermissions.filter { permission ->
                    ContextCompat.checkSelfPermission(context, permission) != PackageManager.PERMISSION_GRANTED
                }.toTypedArray()
        ...
        fun requestBackgroundLocationPermission(
            activity: Activity,
            requestCode: Int = REQUEST_BACKGROUND_LOCATION,
        ) {
        ...
        fun requestAllPermissions(
            activity: Activity,
            requestCode: Int = REQUEST_ALL_PERMISSIONS,
        ) {
            val permissionsToRequest =
        ...
        fun getPermissionExplanation(permission: String): String {
            return when (permission) {
                ...
                Manifest.permission.ACCESS_COARSE_LOCATION,
                ->
                    "La aplicación necesita acceso a la ubicación para rastrear tu ruta " +
                        "durante el senderismo y mostrar tu posición en el mapa."
