package ar.edu.unlam.scaffoldingandroid3.ui.theme
...
data class AppDimens(
    ...
    val markerSize: Dp = 56.dp,
    val mapContentPaddingBottom: Dp = 80.dp,
    val labelMaxWidth: Dp = 120.dp,
    val labelOffset: Dp = (-50).dp
) 